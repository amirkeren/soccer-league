...
CREATE TABLE players(player_id INT AUTO_INCREMENT, name VARCHAR(100), goals_scored INT, team_id INT, PRIMARY KEY (player_id), FOREIGN KEY (team_id) REFERENCES teams(team_id));
...
INSERT INTO teams (name, group_id) VALUES ('Maccabi Liv', 1);
INSERT INTO teams (name, group_id) VALUES ('FC Gute', 1);
INSERT INTO teams (name, group_id) VALUES ('Noon Hampton', 1);
INSERT INTO teams (name, group_id) VALUES ('AC Mido', 1);
INSERT INTO teams (name, group_id) VALUES ('Mexicana United', 2);
INSERT INTO teams (name, group_id) VALUES ('Hapoel Japo', 2);
INSERT INTO teams (name, group_id) VALUES ('Olympique Menza', 2);
INSERT INTO teams (name, group_id) VALUES ('KingGeorge City', 2);
INSERT INTO teams (name, group_id) VALUES ('Inter Marcelos', 3);
INSERT INTO teams (name, group_id) VALUES ('Flieshman FC', 3);
INSERT INTO teams (name, group_id) VALUES ('AL Jamila', 3);
INSERT INTO teams (name, group_id) VALUES ('BechorShoshi United', 3);
