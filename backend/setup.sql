...
CREATE TABLE playoffs(step_id iNT, home_team VARCHAR(50), away_team VARCHAR(50), home_scored INT, away_scored INT);
...
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (1, 'first_a', 'second_b', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (1, 'second_a', 'first_b', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (1, 'first_c', 'weird_a', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (1, 'second_c', 'weird_b', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (2, 'qf_a', 'qf_b', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (2, 'qf_c', 'qf_d', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (3, 'half_a', 'half_b', 0, 0);
INSERT INTO playoffs (step_id, home_team, away_team, home_scored, away_scored) VALUES (4, 'winner', null, 0, 0);
